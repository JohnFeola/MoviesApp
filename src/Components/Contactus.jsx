    ...
    <div className="contact">
      <div className="contact3">
        <section className="leading-relaxed max-w-screen-xl mt-12 mx-auto px-4 md:px-8">
          ...
          <div className="mt-14 gap-4 sm:grid sm:grid-cols-2 lg:grid-cols-3 bg:white">
      ...
      <div className="contact-meet">
        ...
        <div className="contact-team">
          <Avatar
            alt="Remy Sharp"
            src="https://yt3.ggpht.com/-5PREDVCEGPE/AAAAAAAAAAI/AAAAAAAAAAA/MhRKxNR7YQ8/s900-c-k-no/photo.jpg"
          />
          <Avatar
            alt="Travis Howard"
            src="https://yt3.ggpht.com/-5PREDVCEGPE/AAAAAAAAAAI/AAAAAAAAAAA/MhRKxNR7YQ8/s900-c-k-no/photo.jpg"
